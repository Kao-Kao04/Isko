  ...
  return (
    <>
      ...
      <div style={{ minHeight: '100vh', background: '#f8fafc' }}>
        ...
        {/* ── Body ── */}
        <div className="privacy-body" style={{ maxWidth: 1100, margin: '0 auto', padding: '0 24px 80px', display: 'flex', gap: 32, alignItems: 'flex-start', marginTop: -36, position: 'relative', zIndex: 1 }}>
