  ...
  async function handleSaveForm(publishNow = false) {
    ...
    try {
      const data = {
        ...
        eligible_colleges:         form.eligible_colleges.length > 0 ? form.eligible_colleges : null,
        eligible_programs:         form.eligible_programs.length > 0 ? form.eligible_programs : null,
        eligible_year_levels:      form.eligible_year_levels.length > 0 ? form.eligible_year_levels : null,
        amount_raw:                form.amount_raw ? parseInt(form.amount_raw) : null,
        period:                    form.period || undefined,
        scholarship_type:          form.scholarship_type || undefined,
        eligibility_text:          form.eligibility_text || null,
