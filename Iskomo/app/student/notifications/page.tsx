...
function getActionLabel(actionRoute: string | null): string {
  ...
  // Order matters: messages and applications both live under per-application
  // routes, so check the more specific "/messages" prefix first.
