      ...
      <header style={{
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, flexShrink: 0 }}>
            ...
            <Link href="/contact" className="hide-tablet" style={{ display: 'flex', alignItems: 'center', gap: 6, padding: '6px 12px', borderRadius: 8, border: `1px solid #e5e7eb`, background: '#f9fafb', textDecoration: 'none', fontSize: 12, fontWeight: 600, color: '#374151' }}>
