...
export default function OsfaNav() {
    ...
    return (
      <Link href={link.href} aria-current={isActive ? 'page' : undefined}
        ...
        style={{
          ...
          fontWeight: isActive ? 700 : 500, fontSize: 11.5, minWidth: 58,
  ...
  return (
    <>
      {/* Desktop nav */}
      <nav className="osfa-desktop-nav" style={{ display: 'flex', alignItems: 'center', gap: 4 }} role="navigation" aria-label="OSFA navigation">
        ...
        <div ref={moreRef} style={{ position: 'relative' }}>
          <button
            ...
            style={{
              ...
              fontWeight: secondaryActive ? 700 : 500, fontSize: 11.5, minWidth: 54,
              position: 'relative', transition: 'all 0.15s ease',
            }}>
