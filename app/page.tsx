    ...
    <>
      ...
      <div style={{ background: '#fff', fontFamily: "'Inter', sans-serif" }}>
        ...
        <section id="hero" data-dark="true" style={{
          ...
          <div style={{ position:'relative', zIndex:1, maxWidth:780 }}>
            ...
            <p style={{
              ...
              IskoMo is the official scholarship management portal of the&nbsp;
              <span style={{ color:'rgba(255,255,255,0.9)', fontWeight:600 }}>
                Office of Scholarship and Financial Assistance
              </span>{' '}
              at the Polytechnic University of the Philippines – Main Campus.
            </p>
        ...
        <footer style={{ background:'#0d0d0d', color:'rgba(255,255,255,0.45)', padding:'64px 24px 0' }}>
          <div style={{ maxWidth:1080, margin:'0 auto', display:'grid', gridTemplateColumns:'repeat(auto-fit, minmax(180px, 1fr))', gap:40, paddingBottom:52 }}>
            <div>
              <div style={{ display:'flex', alignItems:'center', gap:10, marginBottom:14 }}>
                <img src="/assets/Gemini_Generated_Image_b3g7t6b3g7t6b3g7-removebg-preview.png" alt="IskoMo" style={{ height:36, width:'auto' }} />
              ...
              <p style={{ fontSize:13, lineHeight:1.75, margin:'0 0 14px', color:'rgba(255,255,255,0.40)' }}>
                Official scholarship management portal for PUP Main students.
              </p>
            ...
            {[
              { heading: 'Quick Links', links: [['#hero','Home'],['#about','About'],['#how-it-works','How It Works'],['#challenges','Challenges']] as [string,string][], external: true },
            ].map((col) => (
              <div key={col.heading}>
                <div style={{ fontSize:12, fontWeight:700, color:'#fff', letterSpacing:'0.08em', textTransform:'uppercase', marginBottom:16 }}>{col.heading}</div>
                <ul style={{ listStyle:'none', padding:0, margin:0, display:'flex', flexDirection:'column', gap:10 }}>
                  {col.links.map(([href, label]) => (
                    <li key={href}>
                      {col.external
                        ? <a href={href} style={{ fontSize:14, color:'rgba(255,255,255,0.45)', textDecoration:'none' }}>{label}</a>
                        : <Link href={href} style={{ fontSize:14, color:'rgba(255,255,255,0.45)', textDecoration:'none' }}>{label}</Link>
                      }
                    </li>
                  ))}
                </ul>
            ...
            <div>
              ...
              <a href="mailto:contact@iskomo.ph" style={{ fontSize:14, color:'rgba(255,255,255,0.45)', textDecoration:'none', display:'block', marginBottom:10 }}>contact@iskomo.ph</a>
          ...
          <div style={{ borderTop:'1px solid rgba(255,255,255,0.07)', padding:'24px 0', display:'flex', justifyContent:'space-between', flexWrap:'wrap', gap:10 }}>
